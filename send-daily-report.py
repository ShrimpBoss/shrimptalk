...
# 报告文件路径
REPORT_FILE = "/home/terrence/.openclaw/workspace/daily-report-2026-03-17.html"
...
def send_email():
    ...
    msg['Subject'] = f"📊 每日工作日志 - 2026 年 3 月 17 日（星期二）"
...
您好！以下是 2026 年 3 月 17 日的每日工作日志摘要：
    ...
    try:
        with open(REPORT_FILE, 'rb') as f:
            ...
            attachment.add_header(
                'Content-Disposition',
                'attachment',
                filename="每日工作日志 -2026-03-17.html"
            )
